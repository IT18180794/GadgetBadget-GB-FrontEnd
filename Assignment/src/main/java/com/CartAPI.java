...
public class CartAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String output = CartObj.InsertCart(request.getParameter("productName"),
				 request.getParameter("price"),
				request.getParameter("investmentDetails"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		Map paras = getParasMap(request);
		 ...
		 paras.get("investmentDetails").toString(),
		 paras.get("quantity").toString(),
		paras.get("totalPrice").toString(),
		paras.get("discount").toString());
		response.getWriter().write(output);
	}
